...
function AddAWBButtonForList(id, modalNames) {
    var contents = '';
    contents += '<button class="btn btn-secondary btn-sm rounded-circle" title="Update" data-target="#' + modalNames + '" data-title="Update" data-toggle="modal"  data-id=' + id + '><i class="material-icons">Add</i></button>';
