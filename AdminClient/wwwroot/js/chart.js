( function ( $ ) {
	...
	gradientStroke1.addColorStop(0, '#1c10b6b3');
	gradientStroke1.addColorStop(1, '#1c10b6b3');
	...
	gradientStroke.addColorStop(0, '#1c10b6b3');
	gradientStroke.addColorStop(1, '#1c10b6b3');
    var myChart = new Chart( myCanvas, {
		type: 'line',
		data: {
            ...
            datasets: [ {
				...
				borderColor: '#1c10b6b3',
				pointBackgroundColor:'#fff',
				pointHoverBackgroundColor:gradientStroke,
				pointBorderColor :'#1c10b6b3',
